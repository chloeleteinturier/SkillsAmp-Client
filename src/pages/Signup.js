...
class Signup extends Component {
  ...
  handleFormSubmit = event => {
    ...
    if (photoUrl.length) {
      userService.getOneByEmail(email).then(user => {
        if (user.data.length) {
          this.setState({ message: 'email already exists' });
        } else {
          this.props
            .signup({ password, firstName, lastName, email, photoUrl })
            .then(() => {})
      ...
      <div className='cover-container text-center'>
        ...
        <main className='signin'>
          ...
          >
            ...
            <p>
              or{' '}
              <Link to='/login' className='btn btn-secondary btn-sm ml-2 mr-2'>
                Log in
              </Link>
            ...
            <div className='form-group'>
              <span className='has-float-label'>
                ...
                <div className='valid-feedback'>Looks good!</div>
                <div className='invalid-feedback'>We need a valid email.</div>
              </span>
            </div>
            <div className='form-group custom-file upload-photo'>
              ...
              <label className='custom-file-label' htmlFor='customFile'>
                {' '}
                <i className='fas fa-cloud-upload-alt' /> Upload your photo
              </label>
              <div className='valid-feedback'>Great pic!</div>
              <div className='invalid-feedback'>
            ...
            <div className='form-group form-check'>
              ...
              <label className='form-check-label small' htmlFor='terms'>
                I agree to SkillsAmp’s <a href='#/'>Terms of Service</a>
              </label>
              <div className='invalid-feedback'>
